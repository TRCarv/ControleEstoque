...
public class ProdutoDAO {
    ...
    //METODO PARA INSERIR PRODUTO NO DB
    ...
    // METODO PARA EXCLUIR TODOS OS PRODUTOS DO DB
    public void excluirTodos() {
        String sql = "DELETE FROM produtos";
        try (PreparedStatement stmt = CONEXAO_DB.prepareStatement(sql)) {
            stmt.executeUpdate();
        } catch (SQLException e) {
            System.err.println("Erro ao deletar a tabela: " + e.getMessage());
        }
    }
    ...
    public Produto consultarPorId(int id) {
        ...
        try (PreparedStatement stmt = CONEXAO_DB.prepareStatement(sql)) {
            ...
            System.err.println("Erro ao consultar DB por id: " + e.getMessage());
            return null;
        }
    }

    // METODO PARA ATUALIZAR PRODUTO NO DB
    ...
    // METODO PARA EXCLUIR PRODUTO PELO ID
    ...
    // METODO PARA LISTAR TODOS OS PRODUTOS DO DB
